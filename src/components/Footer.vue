    ...
    <footer class="footer-container">
        <div class="footer-content">
            <div class="footer-grid">
                <div class="footer-section">
                    <h3 class="footer-title">
                        <Gamepad2 class="footer-icon" size="24"/>
                        <span>MIIT GAME</span>
                    </h3>
                    <p class="footer-text">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-list">
                        ...
                        <li class="footer-item">
                            <Phone size="20"/>
                            <span> +57 (310)640-6198 <br>+57 (318)247-5546</span>
                        </li>
                        <li class="footer-item">
                            <Mail size="20"/>
                            <span>pandelpipas@gmail.com makabeuz6618@gmail.com</span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="footer-bottom">
                <p class="copyright">
                    © {{ new Date().getFullYear() }} フレ -../MAKEBUZ/..-ン and T0m4s1n. All rights reserved.
                </p>
            </div>
        </div>
    </footer> 
...
.footer-container {
    ...
    background: linear-gradient(135deg, #0b0c0f 0%, #050507 100%);
    color: #fff;
    padding: 6rem 0 2rem;
    position: relative;
    overflow: hidden;
