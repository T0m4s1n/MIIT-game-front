...
export default {
  ...
  components: {
    ...Object.keys(LucideIcons).reduce((components, iconName) => {
      components[iconName] = LucideIcons[iconName]
      return components
    }, {})
  },
  methods: {
    renderIcon(iconName) {
      return h(LucideIcons[iconName], {
        size: 24, 
